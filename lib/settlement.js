...
//
// ⚠️ ต้องมีคีย์ครบชุดเท่ากับ normalizeSettlement เป๊ะๆ
// เพราะ upsert ทีเดียวทั้งชุดจะยึดคอลัมน์จากแถวแรกเป็นหลัก
// ถ้าแถวนี้มีคีย์น้อยกว่า แถวที่มีตัวเลขจริงจะถูกตัดคอลัมน์เงินทิ้งไปเงียบๆ
