...
// ยกเลิกแบบที่ต้องตามดึงของกลับ
// เช็คจาก "เวลากดจัดส่ง" เป็นหลัก — แพลตฟอร์มส่งมาในก้อนเดียวกับตัวออเดอร์
// จึงรู้ได้แม้เพิ่งมาเห็นตอนยกเลิกไปแล้ว ไม่ต้องพึ่งว่าเราดึงทันตอนมันยังไม่ยกเลิก
// cancelled_from เป็นตัวสำรองไว้ใช้กับแพลตฟอร์มที่ไม่ส่งเวลานั้นมาให้
