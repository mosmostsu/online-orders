...
--   os_orders ลบออเดอร์ที่จบแล้วหลัง 30 วัน (ดู os_cleanup) แต่ยอดปิดหลังสั่ง 10-20 วัน
--   ยอดที่ปิดเมื่อ 20-30 วันก่อน ลองหารายการสินค้าแล้วเจอแค่ 4 ใน 600 ใบ
--   จึงต้องแตกรายสินค้าเก็บไว้ทันทีที่ยอดเข้ามา ตอนที่ออเดอร์ยังอยู่
...
-- ยอดที่ปิดเกิน ~2 สัปดาห์ส่วนใหญ่หาสินค้าไม่เจอแล้ว (ออเดอร์ถูกล้าง) จะไปอยู่ถัง "ไม่ทราบสินค้า"
