...
const LABEL = {
  ...
  // Shopee (get_escrow_detail_batch) — ชื่อฟิลด์คนละชุดกับ TikTok
  // ตรวจกับก้อนดิบจริงแล้ว (ดู lib/shopee.js normalizeMoneyTx) ไม่ใช่เดาจากเอกสารนอกอีกต่อไป
  ...
  'fee.seller_transaction_fee': 'ค่าธรรมเนียมธุรกรรม',
  'fee.service_fee': 'ค่าบริการ',
  'fee.seller_order_processing_fee': 'ค่าธรรมเนียมโครงสร้างพื้นฐานแพลตฟอร์ม',
  'tax.withholding_tax': 'ภาษีหัก ณ ที่จ่าย',
  'ship.actual_shipping_fee': 'ค่าจัดส่งจริง',
  'ship.buyer_paid_shipping_fee': 'ค่าส่งที่ลูกค้าจ่าย',
  'ship.shopee_shipping_rebate': 'ค่าส่งที่ Shopee ช่วยออก',
